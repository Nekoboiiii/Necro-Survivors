...
public class AuraWeapon : Weapon
{
    ...
    public override bool DoLevelUp()
    {
        ...
        // If ther is an aura attached to this weapon we update the aura
        if (currentAura)
        {
            currentAura.transform.localScale = new Vector3(currenStats.area, currentStats.area, currentStats.area);
        }
